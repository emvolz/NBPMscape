### Debugging simgeneration() function

# Part of simtree() function
...
#maxtime=60.0
#p=P
# Alternative version of simgeneration
...
function simgeneration(p, prevgen::Array{Infection}; maxtime = Inf)
	length(prevgen) == 0 && return Array{Infection}([])
	# TODO THERE IS AN ERROR HERE - possibly in "if h["timetransmission"] < maxtime" which sometimes tries to compares a vector with a single value
